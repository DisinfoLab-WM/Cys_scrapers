...
rss_url = "https://factcheckzw.org/feed/"
# Parse RSS Feed
...
for index, entry in enumerate(feed.entries):
    ...
    articles["articles"][str(index)] = {
        ...
        "organization_country": "Zimbabwe",  # Assuming the organization is based in the Philippines
        "site_name": "FactCheckZW",
        "url": entry.link,
        "language": lang,  # Assuming English for all articles
    }
# Save articles to a local JSON file
with open("factcheck_zimbabwe.json", "w", encoding='utf-8') as json_file:
