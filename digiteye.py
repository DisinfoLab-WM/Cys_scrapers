...
rss_url = "https://digiteye.in/feed/"
# Parse RSS Feed
...
for index, entry in enumerate(feed.entries):
    ...
    articles["articles"][str(index)] = {
        ...
        "organization_country": "India",  # Assuming the organization is based in the Philippines
        "site_name": "DigitEye",
        "url": entry.link,
        "language": lang,  # Assuming English for all articles
    }
# Save articles to a local JSON file
with open("DigitEye.json", "w", encoding='utf-8') as json_file:
