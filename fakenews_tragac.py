...
rss_url = "https://fakenews.rs/feed/"
# Parse RSS Feed
...
for index, entry in enumerate(feed.entries):
    ...
    articles["articles"][str(index)] = {
        ...
        "organization_country": "Serbia",  # Assuming the organization is based in the Philippines
        "site_name": "FakeNews Tragač",
        "url": entry.link,
        "language": lang,  # Assuming English for all articles
    }
# Save articles to a local JSON file
with open("fakenews_tragac.json", "w", encoding='utf-8') as json_file:
